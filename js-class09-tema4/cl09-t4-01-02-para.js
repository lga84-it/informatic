document.addEventListener('DOMContentLoaded', () => {
    ...
    const pairs = {
        "Один-до-одного": "Приклад: Кожен учень має один щоденник",
        "Один-до-багатьох (Багато-до-одного)": "Приклад: Один учитель навчає багатьох учнів",
        "Багато-до-багатьох": "Приклад: Багато учнів вивчають по кілька предметів",
      };
