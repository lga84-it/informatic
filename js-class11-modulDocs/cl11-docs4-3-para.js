document.addEventListener('DOMContentLoaded', () => {
    ...
    const pairs = {
        '1. Інстальо-вані шаблони Microsoft Office': "шаблони певних типів докумен-тів (листів, факсів, звітів тощо), які інстальо-вані на комп'ю-тері у складі пакета Microsoft Office",
        '2. Online шаблони Microsoft Office': 'шаблони різнома-нітних типів докумен-тів, які розта-шовані на веб-сайті Microsoft Office Online',
        '3. Шаблони користу-вача в Microsoft Office': 'шаблони, які створені користу-вачем',
      };
