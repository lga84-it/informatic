/**
   ...
   */
const steps = [
    { text: "Теоретичний етап: передбачає формування цілей і задач, визначення об’єкта, виявлення зовнішніх закономірностей і зв’язків", correctIndex: 0 },
    { text: "Методичний етап: пов’язаний зі складанням технологічної карти/схеми управління, вибором і обґрунтуванням засобів, методів і процедур", correctIndex: 1 },
    { text: "Процедурний етап: передбачає реалізацію практичної діяльності технологічного проекту", correctIndex: 2 },
  ];
