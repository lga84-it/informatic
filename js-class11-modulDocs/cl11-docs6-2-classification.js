...
const itemsData = [
    { id: "categ11",  label: "акт про створення корпорацій, компаній",   category: "category-1" },
    { id: "categ12",  label: "акт про створення компаній",   category: "category-1" },
    { id: "categ13",  label: "наказ про створення підприємства",   category: "category-1" },
    { id: "categ14",  label: "наказ про реорганізацію",   category: "category-1" },

    { id: "categ21",  label: "посадові інструкції категорій службовців апарату управління",   category: "category-2" },
    { id: "categ22",  label: "наказ про розподіл обов'язків",   category: "category-2" },

    { id: "categ31",  label: "заява про звільнення",   category: "category-3" },
    { id: "categ32",  label: "наказ про звільнення",   category: "category-3" },

    { id: "categ41",  label: "подання про заохочення",   category: "category-4" },
    { id: "categ42",  label: "доповідна записка",   category: "category-4" },
  ];
