document.addEventListener('DOMContentLoaded', () => {
    ...
    const pairs = {
        "І етап — теоре-тичний": "передба-чає форму-вання цілей і задач, визна-чення об’єкта, виявлення зовнішніх законо-мірностей і зв’язків",
        "ІІ етап — мето-дичний": "пов’яза-ний зі складан-ням тех-нологічної карти/схеми управ-ління, вибором і обґрун-туванням засобів, методів і процедур",
        "ІІІ етап — про-цедурний": "передба-чає реаліза-цію практич-ної діяльності техно-логічного проекту",
      };
