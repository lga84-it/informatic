...
const itemsData = [
    { id: "categ11",  label: "згідно з",   category: "category-1" },
    { id: "categ12",  label: "відповідно до",   category: "category-1" },
    { id: "categ13",  label: "вжити заходів",   category: "category-1" },
    { id: "categ14",  label: "оголосити подяку",   category: "category-1" },
    { id: "categ15",  label: "винести догану",   category: "category-1" },
    { id: "categ16",  label: "брати участь",   category: "category-1" },

    { id: "categ21",  label: "брати до уваги",   category: "category-2" },
    { id: "categ22",  label: "згідно з оригіналом",   category: "category-2" },
    { id: "categ23",  label: "брати активну участь",   category: "category-2" },
    { id: "categ24",  label: "вжити суворих заходів",   category: "category-2" },
    { id: "categ25",  label: "винести сувору догану",   category: "category-2" },

    { id: "categ31", label: "відділ боротьби з організованою злочинністю", category: "category-3" },
    { id: "categ32", label: "контроль за виконанням наказу залишаю за собою", category: "category-3" },
  ];
