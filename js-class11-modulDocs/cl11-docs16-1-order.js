/**
   ...
   */
const steps = [
    { text: "Аналіз формулювання задачі (визначення мети та завдань проекту).", correctIndex: 0 },
    { text: "Створення інформаційної моделі (розробка плану виконання проекту).", correctIndex: 1 },
    { text: "Пошук потрібних матеріалів і відомостей.", correctIndex: 2 },
    { text: "Вибір засобів опрацювання даних.", correctIndex: 3 },
    { text: "Опрацювання матеріалів, аналіз результатів.", correctIndex: 4 },
    { text: "Вибір засобів подання результатів навчального проекту.", correctIndex: 5 },
    { text: "Оформлення результатів проекту; захист проекту.", correctIndex: 6 },
  ];
