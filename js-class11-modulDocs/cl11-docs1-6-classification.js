...
const itemsData = [
    { id: "categ11",  label: "стисло",   category: "category-1" },
    { id: "categ12",  label: "грамотно",   category: "category-1" },
    { id: "categ13", label: "зрозуміло", category: "category-1" },
    { id: "categ14", label: "об’єктивно", category: "category-1" },
    { id: "categ15",  label: "без повторів",   category: "category-1" },
    { id: "categ16",  label: "відрізнятися нейтральним тоном",   category: "category-1" },
    { id: "categ17", label: "без вживання слів і зворотів, що не несуть смислового навантаження", category: "category-1" },

    { id: "categ21",  label: "не стисло",   category: "category-2" },
    { id: "categ22",  label: "не грамотно",   category: "category-2" },
    { id: "categ23", label: "не зрозуміло", category: "category-2" },
    { id: "categ24", label: "суб’єктивно", category: "category-2" },
    { id: "categ25",  label: "з повторами",   category: "category-2" },
    { id: "categ26",  label: "відрізнятися емоційним тоном",   category: "category-2" },
    { id: "categ27", label: "з вживанням слів і зворотів, які несуть смислове навантаження", category: "category-2" },
  ];
