/**
   ...
   */
const steps = [
    { text: "Вивчення суті питання", correctIndex: 0 },
    { text: "Підготовка і написання проекту тексту листа", correctIndex: 1 },
    { text: "Узгодження проекту листа", correctIndex: 2 },
    { text: "Підписання", correctIndex: 3 },
    { text: "Реєстрація", correctIndex: 4 },
    { text: "Відправлення", correctIndex: 5 },
  ];
