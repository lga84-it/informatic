/**
   ...
   */
const steps = [
    { text: "Ідентифікація (Визначення. Хто там?)", correctIndex: 0 },
    { text: "Аутентифікація (Перевірка. Чим доведеш?)", correctIndex: 1 },
    { text: "Авторизація (Доступ Відкриваю!)", correctIndex: 2 },
  ];
