...
const itemsData = [
    { id: "categ1",  label: "- особа, яка створила електронний документ",   category: "category-1" },
    { id: "categ2",  label: "- особа, яка на законних підставах володіє особистим ключем та від свого імені накладає електронний цифровий підпис під час створення електронного документа",   category: "category-2" },
    { id: "categ3", label: "- особа, яка в установленому законодавством порядку здійснює приймання, передавання (доставку), зберігання, перевірку цілісності електронних документів для задоволення власних потреб або надає відповідні послуги за дорученням інших суб'єктів електронного документообігу", category: "category-3" },
    { id: "categ4", label: "- особа, якій адресується документ", category: "category-4" },
  ];
