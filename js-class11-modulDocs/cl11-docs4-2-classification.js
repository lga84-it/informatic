...
const itemsData = [
    { id: "categ11",  label: ".doc",   category: "category-1" },
    { id: "categ12",  label: ".docx",   category: "category-1" },

    { id: "categ21",  label: ".dot",   category: "category-2" },
    { id: "categ22",  label: ".dotx",   category: "category-2" },
    { id: "categ23",  label: ".dotm",   category: "category-2" },
  ];
