/**
   ...
   */
const steps = [
    { text: "розгляд", correctIndex: 0 },
    { text: "порядок проходження документів в організації", correctIndex: 1 },
    { text: "виконання", correctIndex: 2 },
    { text: "контроль виконання", correctIndex: 3 },
    { text: "формування справ", correctIndex: 4 },
  ];
