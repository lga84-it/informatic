...
const itemsData = [
    { id: "categ11",  label: "українська мова викладення документу",   category: "category-1" },
    { id: "categ12",  label: "найменування підприємства, установи, від імені яких складений документ",   category: "category-1" },
    { id: "categ13",  label: "назва документа (форми); дата і місце складання документа; зміст документу",   category: "category-1" },
    { id: "categ14",  label: "посади і прізвища відповідальних (уповноважених) осіб",   category: "category-1" },
    { id: "categ15",  label: "електронний підпис",   category: "category-1" },

    { id: "categ21",  label: "можливість вміщення в документ, крім тексту, мультимедійних даних",   category: "category-2" },
    { id: "categ22",  label: "можливість використання заздалегідь заготовлених форм",   category: "category-2" },
    { id: "categ23",  label: "висока швидкість передачі інформації за великою кількістю адрес",   category: "category-2" },
    { id: "categ24",  label: "економія паперу; висока компактність архіву",   category: "category-2" },
    { id: "categ25",  label: "висока швидкість пошуку і одержання інформації",   category: "category-2" },
  ];
