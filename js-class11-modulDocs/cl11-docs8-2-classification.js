...
const itemsData = [
    { id: "categ11",  label: "Засоби оргтехніки",   category: "category-1" },
    { id: "categ12",  label: "Ремонтно-профілактичні засоби",   category: "category-1" },

    { id: "categ21",  label: "Засоби реєстрації та збору інформації",   category: "category-2" },
    { id: "categ22",  label: "Засоби прийому та передачі даних",   category: "category-2" },
    { id: "categ23",  label: "Засоби підготовки даних",   category: "category-2" },
    { id: "categ24",  label: "Засоби введення даних",   category: "category-2" },
    { id: "categ25",  label: "Засоби обробки інформації",   category: "category-2" },
    { id: "categ26",  label: "Засоби відображення інформації",   category: "category-2" },
  ];
