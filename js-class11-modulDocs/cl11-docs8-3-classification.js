...
const itemsData = [
    { id: "categ11",  label: "Персональний комп'ютер",   category: "category-1" },
    { id: "categ12",  label: "Ноутбук",   category: "category-1" },
    { id: "categ13",  label: "Планшет",   category: "category-1" },
    { id: "categ14",  label: "Смартфон",   category: "category-1" },

    { id: "categ21",  label: "Ксерокс",   category: "category-2" },

    { id: "categ31",  label: "Жорсткий диск",   category: "category-3" },
    { id: "categ32",  label: "Флешка",   category: "category-3" },
    { id: "categ33",  label: "Карта пам'яті",   category: "category-3" },

    { id: "categ41",  label: "Принтер",   category: "category-4" },
    { id: "categ42",  label: "Диктофон",   category: "category-4" },

    { id: "categ51",  label: "Ламінатор",   category: "category-5" },
  ];
